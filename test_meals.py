...
class TestMeals(GroundTests):
    ...
    def test_add_meal(self):
        ...
        response = self.tester.post('/api/v1/meals/', data=json.dumps(self.add_meal_data), headers=self.headers)
    ...
    def test_missing_data_in_input(self):
        ...
        response = self.tester.post('/api/v1/meals/', data=json.dumps(self.add_miss_data), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_type_of_meal_name(self):
        ...
        response = self.tester.post('/api/v1/meals/', data=json.dumps(self.meal_name_typo), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_type_of_meal_price(self):
        ...
        response = self.tester.post('/api/v1/meals/', data=json.dumps(self.meal_price_typo), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_get_meals(self):
        ...
        response = self.tester.get('/api/v1/meals/', headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_meal_exists(self):
        ...
        response = self.tester.put('/api/v1/meals/hvgvg', data=json.dumps(self.modify_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_empty_inputs_in_put(self):
        ...
        response = self.tester.put('/api/v1/meals/'+self.test_meal.meal_id, data=json.dumps(self.mod_emp_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertEqual(data['message'], 'Please enter all the details')
    ...
    def test_meal_name_not_string(self):
        ...
        response = self.tester.put('/api/v1/meals/'+self.test_meal.meal_id, data=json.dumps(self.mod_int_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertEqual(data['message'], 'Please enter a string value for meal')
    ...
    def test_modified_success(self):
        ...
        response = self.tester.put('/api/v1/meals/'+self.test_meal.meal_id, data=json.dumps(self.modify_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_delete_when_meal_unavailable(self):
        ...
        response = self.tester.delete('/api/v1/meals/iugyftg', headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertEqual(data['message'], "The meal was not found")
    ...
    def test_delete_success(self):
        ...
        response = self.tester.delete('/api/v1/meals/'+self.test_meal.meal_id, headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
