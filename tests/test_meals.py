...
class TestMeals(GroundTests):
    ...
    def test_add_meal(self):
        ...
        response = self.tester.post('/api/v2/meals/', data=json.dumps(self.add_meal_data), headers=self.headers)
    ...
    def test_missing_data_in_input(self):
        ...
        response = self.tester.post('/api/v2/meals/', data=json.dumps(self.add_miss_data), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_type_of_meal_price(self):
        ...
        response = self.tester.post('/api/v2/meals/', data=json.dumps(self.meal_price_typo), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_spaces_meal_name(self):
        ...
        response = self.tester.post('/api/v2/meals/', data=json.dumps(self.meal_name_space), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_meal_existing_in_db(self):
        ...
        response = self.tester.post('/api/v2/meals/', data=json.dumps(self.meal_in_db), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_doesnt_meal_exists(self):
        ...
        response = self.tester.put('/api/v2/meals/7', data=json.dumps(self.modify_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_empty_inputs_in_put(self):
        ...
        response = self.tester.put('/api/v2/meals/1', data=json.dumps(self.mod_emp_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertEqual(data['message'], 'Please enter all the details')
    ...
    def test_meal_name_not_string(self):
        ...
        response = self.tester.put('/api/v2/meals/1', data=json.dumps(self.mod_int_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
    ...
    def test_meal_price_not_integer(self):
        '''Check if meal name is not a string'''
        response = self.tester.put('/api/v2/meals/1', data=json.dumps(self.mod_str_price), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertEqual(data['message'], 'Please enter a number value for price')

    def test_meal_name_having_spaces(self):
        '''Check if meal name has spaces'''
        response = self.tester.put('/api/v2/meals/1', data=json.dumps(self.mod_space_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertEqual(data['message'], 'Meal name should not have spaces!')
    ...
    def test_modified_success(self):
        ...
        response = self.tester.put('/api/v2/meals/1', data=json.dumps(self.modify_meal), headers=self.headers)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
